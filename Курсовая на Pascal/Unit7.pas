...
uses
  ...
  Vcl.Imaging.jpeg, Vcl.ExtCtrls, Unit8;
...
procedure TForm7.next10Click(Sender: TObject);
begin
if RadioButton28.Checked=True then n:=n+2;
next10.Visible:=False;
photo10.Visible:=False;
vopros10.Visible:=False;
podskazka10.Visible:=False;
...
procedure TForm7.next11Click(Sender: TObject);
begin
if RadioButton33.Checked=True then n:=n+2;
next11.Visible:=False;
photo11.Visible:=False;
vopros11.Visible:=False;
podskazka11.Visible:=False;
...
procedure TForm7.next12Click(Sender: TObject);
begin
if RadioButton36.Checked=True then n:=n+2;
next12.Visible:=False;
photo12.Visible:=False;
vopros12.Visible:=False;
podskazka12.Visible:=False;
...
procedure TForm7.next1Click(Sender: TObject);
begin
...
procedure TForm7.next2Click(Sender: TObject);
begin
if RadioButton4.Checked=True then n:=n+2;
photo2.Visible:=False;
vopros2.Visible:=False;
podskazka2.Visible:=False;
RadioButton4.Visible:=False;
...
procedure TForm7.next3Click(Sender: TObject);
begin
...
procedure TForm7.next4Click(Sender: TObject);
begin
...
procedure TForm7.next5Click(Sender: TObject);
begin
...
procedure TForm7.next6Click(Sender: TObject);
begin
if RadioButton16.Checked=True then n:=n+2;
next6.Visible:=False;
photo6.Visible:=False;
vopros6.Visible:=False;
podskazka6.Visible:=False;
...
procedure TForm7.next7Click(Sender: TObject);
begin
...
procedure TForm7.next8Click(Sender: TObject);
begin
if RadioButton24.Checked=True then n:=n+2;
next8.Visible:=False;
photo8.Visible:=False;
vopros8.Visible:=False;
podskazka8.Visible:=False;
...
procedure TForm7.next9Click(Sender: TObject);
begin
if RadioButton27.Checked=True then n:=n+2;
next9.Visible:=False;
photo9.Visible:=False;
vopros9.Visible:=False;
podskazka9.Visible:=False;
...
procedure TForm7.podskazka10Click(Sender: TObject);
begin
...
procedure TForm7.podskazka11Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton32.Visible:=False;
n:=n-1;
...
procedure TForm7.podskazka12Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton35.Visible:=False;
n:=n-1;
...
procedure TForm7.podskazka1Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton2.Visible:=False;
n:=n-1;
...
procedure TForm7.podskazka2Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton6.Visible:=False;
n:=n-1;
...
procedure TForm7.podskazka3Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton9.Visible:=False;
n:=n-1;
...
procedure TForm7.podskazka4Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton11.Visible:=False;
n:=n-1;
...
procedure TForm7.podskazka5Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton15.Visible:=False;
n:=n-1;
...
procedure TForm7.podskazka6Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton18.Visible:=False;
n:=n-1;
...
procedure TForm7.podskazka7Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton20.Visible:=False;
n:=n-1;
...
procedure TForm7.podskazka8Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton22.Visible:=False;
n:=n-1;
...
procedure TForm7.podskazka9Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton25.Visible:=False;
n:=n-1;
