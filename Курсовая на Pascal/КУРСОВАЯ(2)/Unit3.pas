...
uses
  ...
  Vcl.Imaging.pngimage, Vcl.Imaging.jpeg, Vcl.ExtCtrls, Unit5;
...
procedure TForm3.next2Click(Sender: TObject);
begin
if RadioButton5.Checked=True then n:=n+2;
photo2.Visible:=False;
vopros2.Visible:=False;
podskazka2.Visible:=False;
RadioButton4.Visible:=False;
...
procedure TForm3.next3Click(Sender: TObject);
begin
if RadioButton7.Checked=True then n:=n+2;
next3.Visible:=False;
photo3.Visible:=False;
vopros3.Visible:=False;
podskazka3.Visible:=False;
...
procedure TForm3.next4Click(Sender: TObject);
begin
...
procedure TForm3.next5Click(Sender: TObject);
begin
if RadioButton14.Checked=True then n:=n+2;
next5.Visible:=False;
photo5.Visible:=False;
vopros5.Visible:=False;
podskazka5.Visible:=False;
...
procedure TForm3.next6Click(Sender: TObject);
begin
...
procedure TForm3.next7Click(Sender: TObject);
begin
if RadioButton19.Checked=True then n:=n+2;
next7.Visible:=False;
photo7.Visible:=False;
vopros7.Visible:=False;
podskazka7.Visible:=False;
...
procedure TForm3.next8Click(Sender: TObject);
begin
...
procedure TForm3.next9Click(Sender: TObject);
begin
if RadioButton26.Checked=True then n:=n+2;
next9.Visible:=False;
photo9.Visible:=False;
vopros9.Visible:=False;
podskazka9.Visible:=False;
...
procedure TForm3.next10Click(Sender: TObject);
begin
if RadioButton29.Checked=True then n:=n+2;
next10.Visible:=False;
photo10.Visible:=False;
vopros10.Visible:=False;
podskazka10.Visible:=False;
...
procedure TForm3.next11Click(Sender: TObject);
begin
if RadioButton32.Checked=True then n:=n+2;
next11.Visible:=False;
photo11.Visible:=False;
vopros11.Visible:=False;
podskazka11.Visible:=False;
...
procedure TForm3.next12Click(Sender: TObject);
begin
if RadioButton35.Checked=True then n:=n+2;
next12.Visible:=False;
photo12.Visible:=False;
vopros12.Visible:=False;
podskazka12.Visible:=False;
...
begin
if RadioButton1.Checked=True then n:=n+2;
...
procedure TForm3.podskazka10Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton30.Visible:=False;
n:=n-1;
podskazka10.Visible:=False;
end;

procedure TForm3.podskazka11Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton33.Visible:=False;
n:=n-1;
...
procedure TForm3.podskazka12Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton34.Visible:=False;
n:=n-1;
...
procedure TForm3.podskazka1Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton2.Visible:=False;
n:=n-1;
...
procedure TForm3.podskazka2Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton4.Visible:=False;
n:=n-1;
...
procedure TForm3.podskazka3Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton8.Visible:=False;
n:=n-1;
...
procedure TForm3.podskazka4Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton11.Visible:=False;
n:=n-1;
...
procedure TForm3.podskazka5Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton15.Visible:=False;
n:=n-1;
...
procedure TForm3.podskazka6Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton17.Visible:=False;
n:=n-1;
...
procedure TForm3.podskazka7Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton21.Visible:=False;
n:=n-1;
...
procedure TForm3.podskazka8Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton24.Visible:=False;
n:=n-1;
...
procedure TForm3.podskazka9Click(Sender: TObject);
begin
MessageBox(Handle, 'Мы убрали один неправильный ответ', 'Подсказка', 0);
RadioButton27.Visible:=False;
n:=n-1;
